...
public class Q4 {
    public static void main(String[] args) throws IOException {
        ...
        employeeList.add(new  Employee(5,"even",1223,"dbsatawwwlhy373@gmail.com","ro3332",new Address("Odisha","Cuttack","753014")));
        employeeList.add(new Employee(6,"odd",1200,"dbsat3@gmail.com","rock32",new Address("Odisha","Cuttack","753014")));
